...
public class MapInterface {
	...
	public static void main(String[] args) {
		 ...
		 * key can map to at most one value. * Map General Implementation -- HashMap
		 * 
		 * SortedMap extends Map interface NavigatableMap extends SortedMap interface
		...
		System.out.println("priceMap.putIfAbsent(Potato, 100D) : " + priceMap.putIfAbsent("Potato", 100D));
		System.out.println("priceMap.putIfAbsent(Lolipop, 10D) : " + priceMap.putIfAbsent("Lolipop", 10D));

		// V getOrDefault(Object key, V defaultValue)
		System.out
				.println(" my banana price , if not found return 0.0 -->>  : " + priceMap.getOrDefault("Banana", 0.0));
		System.out.println(" my Corn price , if not found return 0.0 -->>  : " + priceMap.getOrDefault("Corn", 0.0));

		// boolean remove(Object key, Object value)
		System.out.println("removing Potato with 3.02 $  : " + priceMap.remove("Potato", 3.02));
		System.out.println("removing Potato with 99.99 $  : " + priceMap.remove("Potato", 99.99));
		System.out.println("removing ABC with 99.02 $  : " + priceMap.remove("ABC", 99.99));

		// V replace(K key, V value)

		System.out.println("Replacing Watermelon price of 4.92 to 0.99 -->>> " + priceMap.replace("Watermelon", 0.99));
